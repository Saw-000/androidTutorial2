...
class SleepTrackerFragment : Fragment() {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?,
        ...
        /** Listadapter さんに changed した dataSet を　パス 。 */
        sleepTrackerViewModel.nights.observe(viewLifecycleOwner, Observer {
            it?.let {
                adapter.submitList(it) /** data の変更->更新開始*/
            }
        })
        ...
        /** Change the layoutManager of the recycleView!*/
        binding.sleepList.layoutManager = GridLayoutManager(activity, 3, GridLayoutManager.HORIZONTAL, false)
        return binding.root
    }
}
