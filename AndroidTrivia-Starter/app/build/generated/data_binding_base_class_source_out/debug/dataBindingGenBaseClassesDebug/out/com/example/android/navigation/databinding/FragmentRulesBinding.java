...
public abstract class FragmentRulesBinding extends ViewDataBinding {
  ...
  @NonNull
  public final ConstraintLayout rulesConstraint;
  ...
  protected FragmentRulesBinding(Object _bindingComponent, View _root, int _localFieldCount,
      Button playButton, ConstraintLayout rulesConstraint, ImageView rulesImage,
      TextView rulesText) {
    super(_bindingComponent, _root, _localFieldCount);
    this.playButton = playButton;
    this.rulesConstraint = rulesConstraint;
